...
function GlobalStatus() {
  return (
    <div className="space-y-6">
      ...
      <div>
        서비스의 모든 기능은 자주 방문하는 도서관을 중심으로 제공됩니다. 이러한
        특성상 도서관 목록을 전역적으로 관리할 필요가 있었습니다. React 기반으로
        서비스를 개발했기 때문에 다양한 상태관리 라이브러리를 선택할 수
        있었습니다.
      </div>
      <div>
        여러 옵션을 검토한 결과, 구현하고자 하는 기능이 전역 상태 관리를 필요로
        하므로 Jotai나 Recoil과 같은 Atomic 패턴의 라이브러리보다 스토어 기반의
        라이브러리가 더 적합하다고 판단했습니다. 보일러플레이트가 적고 직관적인
        API를 제공하는 Zustand를 선택하여 도서관 목록과 관련 상태를 효율적으로
        관리할 수 있었습니다.
      </div>
      <div className="relative">
        <Image
